        ...
        <div class="mx-3 row align-items-end">
            ...
            <div class="mb-3 col-sm-12 col-md-4">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="operacao" id="venda" value="venda" checked>
                    <label class="form-check-label" for="venda">Venda</label>
                </div>
                <div class="form-check">
                    <label class="form-check-label" for="troca">Troca</label>
                    <input class="form-check-input" type="radio" name="operacao" id="troca" value="troca">
                </div>
                <div class="form-check">
                    <label class="form-check-label" for="ambos">Ambos</label>
                    <input class="form-check-input" type="radio" name="operacao" id="ambos" value="ambos">
                </div>
            </div>
        </div>
