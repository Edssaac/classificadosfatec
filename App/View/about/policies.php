<section class="bg-light rounded my-4 mb-5">
    <div class="py-4">
        <h3 class="text-center text-danger mb-4">Políticas</h3>
        <p class="mx-4 text-justify-content">
            A sua privacidade é importante para nós. É política do Classificados Fatec respeitar a sua privacidade em relação a
            qualquer informação sua que possamos coletar no site Classificados Fatec, e outros sites que possuímos e operamos.
        </p>
        <p class="mx-4 text-justify-content">
            Solicitamos informações pessoais apenas quando realmente precisamos delas para lhe fornecer um serviço. Fazemo-lo por
            meios justos e legais, com o seu conhecimento e consentimento. Também informamos por que estamos coletando e como será usado.
        </p>
        <p class="mx-4 text-justify-content">
        ...
        <p class="mx-4 text-justify-content">
            ...
            pessoais. Se você tiver alguma dúvida sobre como lidamos com dados do usuário e informações pessoais, entre em contato conosco.
        </p>
    </div>
</section>