<section class="bg-light rounded my-4 mb-5">
    <form action="/atualziar_perfil" method="post" class="py-4 mx-lg-5">
        ...
        <div class="mb-3 mx-4">
            ...
            <input type="date" id="data_nascimento" name="data_nascimento" class="form-control input-cinza" value="<?= $this->view->usuario["data_nascimento"] ?>" required>
        </div>
        <div class="mb-3 mx-4">
        ...
        <div class="mb-3 mx-4">
            ...
            <input type="email" id="email" name="email" class="form-control input-cinza" value="<?= $this->view->usuario["email"] ?>" autocomplete="false" disabled>
        </div>
        <div class="mb-3 mx-4">
